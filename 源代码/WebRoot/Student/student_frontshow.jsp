...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=student.getSex()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">学生照片:</div>
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=student.getStudentPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">年级:</div>
		<div class="col-md-10 col-xs-6"><%=student.getGradeObj().getGradeName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">专业:</div>
		<div class="col-md-10 col-xs-6"><%=student.getSpecialObj().getSpecialName() %></div>
	</div>
	<div class="row bottom15"> 
