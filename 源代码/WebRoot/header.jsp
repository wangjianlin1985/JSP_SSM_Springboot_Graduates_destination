        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>SpecialInfo/frontlist">专业</a></li>
                <li><a href="<%=basePath %>GradeInfo/frontlist">年级</a></li> 
                <li><a href="<%=basePath %>Student/frontlist">学生</a></li>-->
                <li><a href="<%=basePath %>GetJobStudent/frontlist">就业学生</a></li>
                <li><a href="<%=basePath %>GraduateStudent/frontlist">考研学生</a></li>
                <li><a href="<%=basePath %>EntrepreneurStudent/frontlist">创业学生</a></li>
                <li><a href="<%=basePath %>ServantStudent/frontlist">公务员学生</a></li>
                <li><a href="<%=basePath %>ArmyStudent/frontlist">参军学生</a></li>
                <li><a href="<%=basePath %>UnderemployedStudent/frontlist">未就业学生</a></li>
                <li><a href="<%=basePath %>OtherStudent/frontlist">其他学生</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Student/student_frontAdd.jsp" onclick="register();"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Student/student_selfModify.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li> 
                    </ul>
                </li>
